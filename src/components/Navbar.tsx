...
const Navbar = () => {
  ...
  // Monitor specifically for Shadcn/Radix UI Dialog which aggressively sets pointer-events: none on the body.
  // This avoids conflicts with Lenis smooth scroll or generic data-scroll-locked behaviors.
  useEffect(() => {
    const checkModalState = () => {
      setIsModalOpen(document.body.style.pointerEvents === 'none');
    };
